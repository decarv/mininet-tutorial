...
class ControllerSwitch(object):
  ...
  def act_like_switch (self, packet, packet_in):
    ...
    srcaddr = str(packet.src)
    srcport = packet_in.in_port
    self.mac_to_port[srcaddr] = srcport

    # NOTE: look for dstaddr in dict to 
    dstaddr = str(packet.dst)
...
def launch ():
  ...
  def start_switch (event):
    ...
    ControllerSwitch(event.connection)
